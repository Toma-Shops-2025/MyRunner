...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-McwCr4Ln.mjs");
...
const manifest = {
  "a6b1e7cf7e3f22a01fbd54fdaf632547a26b8860897e09ffc00e4ada0cc08f2f": {
    functionName: "fetchRunner_createServerFn_handler",
    importer: () => import("./r._id-D39TXhkB.mjs")
  },
  "f12acf9adf0dc8da5c08e85517a0bed951a2daee908ef527af74e63b2ec6887a": {
    functionName: "startDriverBackgroundCheck_createServerFn_handler",
    importer: () => import("./checkr.functions-BKJr--K1.mjs")
  },
  "e35f650e73dce0dd2cfd64dcc2349fcbd818102306d1fcb44ea7c9682af56bbf": {
    functionName: "dispatchOrder_createServerFn_handler",
    importer: () => import("./dispatch.functions-BfeOH0dd.mjs")
  },
  "cd00e8864ffdfbda6361a4251d5654b28297f8da483bda28cda04f2a0e647c2e": {
    functionName: "acceptOffer_createServerFn_handler",
    importer: () => import("./dispatch.functions-BfeOH0dd.mjs")
  },
  "667bcc7bf65430d37adb6df782a5368d1bcde1f9ec41e7d5d05c09f4fe756d80": {
    functionName: "declineOffer_createServerFn_handler",
    importer: () => import("./dispatch.functions-BfeOH0dd.mjs")
  },
  "566e1e1a14460ca7d48922f53684228e5f66ccbc7f8af58bd4378b46592fe75a": {
    functionName: "reassignExpired_createServerFn_handler",
    importer: () => import("./dispatch.functions-BfeOH0dd.mjs")
  },
  "8764abbbf0d0b0490badae9e5c4926fd4710c2a8b5f2c0aaac29ccb5bc3e17e0": {
    functionName: "setDriverPresence_createServerFn_handler",
    importer: () => import("./dispatch.functions-BfeOH0dd.mjs")
  },
  "e7c272786cb41489cadc823410a79f317413773b7b677ef412f6c3867c1d0bdc": {
    functionName: "getPublicConfig_createServerFn_handler",
    importer: () => import("./config.functions-DElzt3-2.mjs")
  },
  "d4c55b7671b63819bd87bbdf9e310bb3ae4dd819ffb7a4c2f6959543bfe84a45": {
    functionName: "createCheckoutSession_createServerFn_handler",
    importer: () => import("./checkout.functions-BPF_7Q8p.mjs")
  },
  "670a0e5a54b79c4516b09ebcb01cdaf4248647876535eab9ee0ad8e49b1cad42": {
    functionName: "createTipCheckoutSession_createServerFn_handler",
    importer: () => import("./checkout.functions-BPF_7Q8p.mjs")
  },
  "85b7a3174a7c86ada231dfad8b07c7d29473fdd542762a1ff77cf462ff998f4e": {
    functionName: "createConnectAccount_createServerFn_handler",
    importer: () => import("./connect.functions-BqeUHtnU.mjs")
  },
  "f7b87ff48da9e21892a6b685a794e2c6e6f21cf6f7e32912ee9ce0f4769af37b": {
    functionName: "createOnboardingLink_createServerFn_handler",
    importer: () => import("./connect.functions-BqeUHtnU.mjs")
  },
  "82bd273ab0a0d3c84f260e47dbb167e8f59003492349ddb51f392b9f1da82248": {
    functionName: "refreshAccountStatus_createServerFn_handler",
    importer: () => import("./connect.functions-BqeUHtnU.mjs")
  },
  "b58094d7b8ec6f8db051111ee0bf59fbf0e777e711c59501395a6a0d268ccef3": {
    functionName: "createDashboardLink_createServerFn_handler",
    importer: () => import("./connect.functions-BqeUHtnU.mjs")
  },
  "570058cf6b0042e8fa6a4e0d848e7d53166e4183449f5f325065fa98e3ee485c": {
    functionName: "payoutDriverForOrder_createServerFn_handler",
    importer: () => import("./connect.functions-BqeUHtnU.mjs")
  },
  "40bef2cf70ea6e1cff8b718a877f4e1d7b5f04ea2689194d15074b48a2c3926a": {
    functionName: "listDriversForAdmin_createServerFn_handler",
    importer: () => import("./admin-drivers.functions-C108cT7n.mjs")
  },
  "2823ff8374858c242ff9368cc18e15e4d7b02f12cf5c4e41b4c9fb80d9255b51": {
    functionName: "updateDriverBackgroundCheck_createServerFn_handler",
    importer: () => import("./admin-drivers.functions-C108cT7n.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CcOqsHDG.mjs").then((n) => n.r),
    import("./start-DC2lxaJk.mjs"),
